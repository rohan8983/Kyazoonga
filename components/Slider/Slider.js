    ...
    >
      ...
      <div className="site-manu container">
        ...
        <div className="banner-serch-box">
          <input
            ...
            type="text"
          />
          <a href="javascript:void(0);" onClick={e => searchfor()}>
      ...
      <div className="carousel-inner">
        ...
        <div data-slide="0" className="item active">
          <img
            src="http://content.kyazoonga.com/Footer/slider-1.jpg"
            alt=""
          ...
          <div className="hide-on-mobile">
            ...
            >
              <source
                src="http://content.kyazoonga.com/videos/video9.mp4"
                type="video/mp4"
              />
        ...
        <div data-slide="1" className="item">
          ...
          <div className="hide-on-mobile">
            ...
            >
              <source
                src="http://content.kyazoonga.com/videos/video1.mp4"
                type="video/mp4"
              />
              Your browser does not support the video tag.
            </video>
        ...
        <div data-slide="2" className="item">
          ...
          <div className="hide-on-mobile">
            ...
            >
              <source
                src="http://content.kyazoonga.com/videos/video2.mp4"
                type="video/mp4"
              />
              Your browser does not support the video tag.
            </video>
        ...
        <div data-slide="3" className="item">
          ...
          <div className="hide-on-mobile">
            ...
            >
              <source
                src="http://content.kyazoonga.com/videos/video3.mp4"
                type="video/mp4"
              />
              Your browser does not support the video tag.
            </video>
        ...
        <div data-slide="4" className="item">
          ...
          <div className="hide-on-mobile">
            ...
            >
              <source
                src="http://content.kyazoonga.com/videos/video8.mp4"
                type="video/mp4"
              />
              Your browser does not support the video tag.
            </video>
